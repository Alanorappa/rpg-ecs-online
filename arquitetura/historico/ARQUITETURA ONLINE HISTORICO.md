# Histórico — ARQUITETURA_ONLINE.md (decisões datadas + problemas conhecidos)

> Extraído de ARQUITETURA_ONLINE.md em 08/08/2026 durante limpeza de documentação.
> Contém as decisões item 15 em diante (já datadas na origem) e toda a seção
> 'Problemas conhecidos e TODOs'. Consultar sob demanda, não é leitura obrigatória.
