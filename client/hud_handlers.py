...
class HudHandlers:
    ...
    def _draw_hud(self):
        ...
        self.screen.blit(zone_surf, (self.screen.get_width() - zone_surf.get_width() - 10, 10))
        ...
        if tile_move:
            ...
            self.screen.blit(coord_surf, (self.screen.get_width() - coord_surf.get_width() - 10, 28))
            if self._current_zone:
                zone_txt  = self.font_sm.render(self._current_zone, True, (160, 200, 160))
                self.screen.blit(zone_txt, (self.screen.get_width() - zone_txt.get_width() - 10, 46))
