...
Uso:
    from fx import FLT, PROC, WARN, SOUNDS, DASH_TRAIL   # em world_systems etc.
...
def bind_client_fx() -> None:
    ...
    """
    from floating_text import FLT as _flt, PROC as _proc, WARN as _warn, \
                              DASH_TRAIL as _dash
    from sound_manager import SOUNDS as _sounds
    FLT.bind(_flt)
    PROC.bind(_proc)
    WARN.bind(_warn)
