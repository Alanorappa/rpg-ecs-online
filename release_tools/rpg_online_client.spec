...
#
# Uso:  py -3.10 -m PyInstaller release_tools\rpg_online_client.spec --noconfirm
#       (invocado por release_tools/build_client.ps1)
#
...
#   - SPECPATH (injetado pelo PyInstaller = pasta deste .spec, release_tools/)
#     usado pra achar main.py na raiz do projeto — PyInstaller resolve o script
#     de Analysis relativo ao .spec, NÃO ao CWD de onde foi invocado.
