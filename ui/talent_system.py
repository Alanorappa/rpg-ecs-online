...
from content.talent_data import BUILDS, TALENTS, BUILD_TALENTS
from ui.combat_log import LOG
from engine.save_system import request_autosave
from engine.stat_fns import add_modifier, remove_modifier
...
class TalentSystem(UIScaleMixin):
    ...
    def apply_talent_effects(self):
        from engine.components import TalentTree, CombatStats, PlayerSkills, Modifier, CharacterStats
        from content.talent_data import CLASS_BUILD_MAP
        tt     = self._talent_tree()
    ...
    def _live_effects(self, talent_id: str, current: int, tt) -> list[tuple[str, tuple]]:
        from engine.components import CombatStats as _CS_LE
